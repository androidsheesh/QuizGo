        ...
        <main class="max-w-6xl mx-auto mt-16 md:mt-20 w-full px-6">
            ...
            <div class="max-w-4xl mx-auto w-full flex flex-col">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-500 mt-1">{{ $totalCards }} Cards</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-20">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" id="flashcards-container">
                        @if($flashcards->count() > 0)
                            @include('decks.partials.flashcards', ['flashcards' => $flashcards, 'deck' => $deck])
                        @else
                    ...
                    @if($flashcards->hasMorePages())
                        <div x-data="{
                                loading: false,
                                nextUrl: '{{ $flashcards->nextPageUrl() }}',
                                init() {
                            ...
                            class="w-full flex justify-center mt-10 h-20"
                        >
                            <div x-show="loading" class="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-emerald-500"></div>
                        </div>
                    @endif
                </div>
